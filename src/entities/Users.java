...
public class Users {
    ...
    private int ID_USERS,STATUS;
    private String FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,PROFILE_PHOTO;

    public Users() {
    }

    public Users(int ID_USERS, String FIRST_NAME, String LAST_NAME, String EMAIL, String PASSWORD, String PROFILE_PHOTO, int STATUS) {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        return new Users(this.ID_USERS, this.FIRST_NAME, this.LAST_NAME, this.EMAIL, this.PASSWORD, this.PROFILE_PHOTO,this.STATUS);
